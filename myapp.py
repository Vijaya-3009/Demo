...
with col1:
  ...
  st.image("./Tanjiro.jpeg", caption="Tanjiro Kamado", width=300,use_column_width=True)
  st.write("Tanjiro Kamado is a Demon Slayer")
with col2:
  st.subheader("Nezuko Kamado")
  st.image("./nejuko.jpeg", caption="Tanjiro Kamado", width=300,use_column_width=True)
